 ...
 * All new code should import directly from '@/shared/api/core-client' or '@/lib/api'.
 * 
...
// For backward compatibility with `import api from '@/shared/api/client'`
export { apiClient as api } from '@/shared/api/core-client';
export { apiClient as default } from '@/shared/api/core-client';
