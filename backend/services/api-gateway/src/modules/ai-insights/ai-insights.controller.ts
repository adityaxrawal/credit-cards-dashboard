...
export class AiInsightsController {
  static async create(req: Request, res: Response): Promise<void> {
    try {
      const result = await aiaIInsightsService.create(req.body);
  ...
  static async getById(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
      const result = await aiaIInsightsService.getById(id);
  ...
  static async getAll(req: Request, res: Response): Promise<void> {
    try {
      ...
      const result = await aiaIInsightsService.getInsights(userId);
      res.status(HTTP_STATUS.OK).json(result);
    } catch (error: any) {
  ...
  static async update(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
      const result = await aiaIInsightsService.update(id, req.body);
      res.status(HTTP_STATUS.OK).json(result);
    } catch (error: any) {
  ...
  static async delete(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
      await aiaIInsightsService.delete(id);
