...
describe('Auth Routes Integration Tests', () => {
  ...
  describe('POST /api/auth/google', () => {
    ...
    it('should handle database errors', async () => {
      mockAuthService.googleOAuth.mockRejectedValue(new Error('Database connection failed'));
  ...
  describe('POST /api/auth/refresh', () => {
    ...
    it('should return 401 if session expired', async () => {
      mockAuthService.refreshAccessToken.mockRejectedValue(new Error('Session expired'));
  ...
  describe('POST /api/auth/logout', () => {
    it('should logout successfully with valid token', async () => {
      ...
      (redis.get as jest.Mock) = jest.fn().mockResolvedValue(JSON.stringify({ accessToken }));
  ...
  describe('GET /api/auth/me', () => {
    ...
    it('should return 404 if user not found', async () => {
      ...
      (redis.get as jest.Mock) = jest.fn().mockResolvedValue(JSON.stringify({ accessToken }));
      mockAuthService.getUserInfo.mockRejectedValue(new Error('User not found'));
  ...
  describe('Authentication Flow Integration', () => {
    it('should complete full authentication flow', async () => {
      ...
      (redis.get as jest.Mock) = jest.fn().mockResolvedValue(JSON.stringify({ accessToken, refreshToken }));
      mockAuthService.getUserInfo.mockResolvedValue(mockUser);
