...
const aiInsightsController = path.join(
  srcDir,
  "modules/ai-insights/ai-insights.controller.ts"
);
...
// Alerts Controller
const alertsController = path.join(
  srcDir,
...
const analyticsController = path.join(
  srcDir,
...
// Budgets Controller
const budgetsController = path.join(
  srcDir,
...
// Reports Controller
const reportsController = path.join(
  srcDir,
...
const rewardsController = path.join(
  srcDir,
  "modules/rewards/rewards.controller.ts"
);
let rewardsContent = fs.readFileSync(rewardsController, "utf8");

// Fix method names
rewardsContent = rewardsContent.replace(
  /rewardsService\.create/g,
  "rewardsService.trackReward"
);
rewardsContent = rewardsContent.replace(
  /rewardsService\.getRewardById/g,
  "rewardsService.getReward"
);
rewardsContent = rewardsContent.replace(
  /rewardsService\.getRewards/g,
  "rewardsService.getUserRewards"
);
rewardsContent = rewardsContent.replace(
  /rewardsService\.update/g,
  "rewardsService.updateReward"
);
rewardsContent = rewardsContent.replace(
  /rewardsService\.delete/g,
...
const subscriptionsController = path.join(
  srcDir,
...
subsContent = subsContent.replace(
  /subscriptionService\.addSubscription/g,
  "SubscriptionService.addSubscription"
);
subsContent = subsContent.replace(
  /subscriptionService\.getSubscriptionById/g,
  "SubscriptionService.getSubscriptionById"
);
subsContent = subsContent.replace(
  /subscriptionService\.getUserSubscriptions/g,
  "SubscriptionService.getUserSubscriptions"
);
subsContent = subsContent.replace(
  /subscriptionService\.updateSubscriptionStatus/g,
  "SubscriptionService.updateSubscriptionStatus"
);
subsContent = subsContent.replace(
  /subscriptionService\.cancelSubscription/g,
...
const transactionsController = path.join(
  srcDir,
...
authContent = authContent.replace(
  /ERROR_MESSAGES\.AUTH\.AUTH_FAILED/g,
