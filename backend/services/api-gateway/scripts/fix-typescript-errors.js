...
const aiInsightsControllerPath = path.join(__dirname, '../src/modules/ai-insights/ai-insights.controller.ts');
let aiInsightsController = fs.readFileSync(aiInsightsControllerPath, 'utf8');
aiInsightsController = aiInsightsController.replace(/aiaIInsightsService/g, 'aIInsightsService');
...
// Analytics module
const analyticsIndexPath = path.join(__dirname, '../src/modules/analytics/index.ts');
...
// Budgets module
const budgetsIndexPath = path.join(__dirname, '../src/modules/budgets/index.ts');
...
// Reports module
const reportsIndexPath = path.join(__dirname, '../src/modules/reports/index.ts');
...
const controllerFixes = [
  ...
  },
  {
    ...
    replacements: [
      ...
      { old: 'AnalyticsService.getAnalyticById', new: 'analyticsService.getAnalyticById' },
      { old: 'AnalyticsService.getAnalytics', new: 'analyticsService.getAnalytics' },
  ...
  },
  {
    ...
    replacements: [
      ...
      { old: 'BudgetService.getBudgetById', new: 'budgetService.getBudgetById' },
  ...
  },
  {
    ...
    replacements: [
      ...
      { old: 'ReportService.getReportById', new: 'reportService.getReportById' },
...
const billsServicePath = path.join(__dirname, '../src/modules/bills/bills.service.ts');
...
billsService = billsService.replace(/AlertService\.createAlert/g, 'alertService.createAlert');
