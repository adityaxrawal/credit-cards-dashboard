...
import { activeJobs } from './websocket-state';
    ...
    io.on('connection', (socket) => {
        ...
        socket.on('subscribe', async (data) => {
            ...
            if (userId) {
                ...
                try {
                    const { safeQuery } = await import('@shared/database/db');
...
export { broadcastProcessingUpdate, broadcastJobComplete, sendUserAlert } from './websocket-state';
