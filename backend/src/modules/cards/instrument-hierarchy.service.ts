...
import { UPIHandleService } from './upi-handle.service';
import { Bank, BankAccount, CreditCard, DebitCard, UPIHandle, UUID, BankHierarchy } from '@shared/types/instruments.types';
