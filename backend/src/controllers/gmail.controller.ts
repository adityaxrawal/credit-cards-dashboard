...
import { IGmailService } from '../interfaces/services';
 ...
 */
export function createGmailController(gmailService: IGmailService): IGmailController {
  return {
...
const defaultController = createGmailController(gmailService as IGmailService);
