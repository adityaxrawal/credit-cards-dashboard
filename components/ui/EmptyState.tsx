  ...
  return (
    ...
    >
      <motion.div
        ...
        className="mb-6"
      >
        <div className={`${currentSize.iconContainer} mx-auto bg-gradient-to-br from-gray-700/30 to-gray-800/30 rounded-full flex items-center justify-center backdrop-blur-sm border border-gray-600/20`}>
